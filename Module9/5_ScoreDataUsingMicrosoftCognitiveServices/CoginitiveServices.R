...
source("./5_ScoreDataUsingMicrosoftCognitiveServices/MyKey.R")
...
# Get API endpoint
api_end_point <- "https://eastus.api.cognitive.microsoft.com/text/analytics/v2.0/sentiment"

# Get the data needed for scoring from out yelp data set and convert it to JSON
request_body <- select(yelp_data, language, id, text)
